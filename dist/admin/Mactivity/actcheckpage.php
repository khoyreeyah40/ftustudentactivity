...
<body class="fixed-navbar">
    <div class="page-wrapper">
        ...
        <?php
            ...
            ?>
                <li class="active">
                    <a href="actcheckpage.php" aria-hidden="true"><i class="sidebar-item-icon fa fa-check-square"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-content fade-in-up">
                <div class="row">
                    <div class="col-12">
                            <iframe height="1084px" width="100%"  name="iii" src="actchecksearch.php" style="border:none" > </iframe>
