...
<head>
    ...
    <title>ระบบกิจกรรมนักศึกษา| จัดการส่งคำร้องขอกิจกรรม</title>
...
<body class="fixed-navbar">
    <div class="page-wrapper">
        ...
        <?php
            ...
            ?>
                <li class="active">
                    <a href="actreqpage.php" aria-hidden="true"><i class="sidebar-item-icon fa fa-envelope"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="page-content fade-in-up">
                <div class="row">
                    <div class="col-12">
                            <iframe height="1084px" width="100%"  name="iii" src="actreq.php" style="border:none" > </iframe>
