...
if (isset($_POST['id'])) {
    $id = $_POST['id'];
    $stmt_view = $DB_con->prepare('SELECT activity.*, organization.*, acttype.*, mainorg.*,actsem.*
                                   FROM activity 
            ...
            <div class="card-body ">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="pill-1-1">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?php echo $actTimeb; ?> ถึง <?php echo $actTimee; ?></td>
                            </tr>
                            <tr>
                                <td style="color:#417d19;" style="font-size:16px;width: 30%;"><b>วันที่จัด</td>
                                <td><?php echo $actDateb; ?> ถึง <?php echo $actDatee; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="color:#417d19;" style="font-size:16px;width: 30%;"><b>ใบโครงการ</td>
                                <td><a href="../file/<?php echo $actFile; ?>" target ="_blank" ><?php echo $actFile; ?></a></td>
                            </tr>
                            <tr>
                                <td style="color:#417d19;" style="font-size:16px;width: 30%;"><b>ลิ้งค์ใบประเมิน</td>
                                <td><a href="<?php echo $actAssesslink; ?>" target ="_blank" ><?php echo $actAssesslink; ?></a></td>
                            </tr>
                    ...
                    <div class="tab-pane" id="pill-1-2">
                        <table id="tbactreg" class="table table-hover table-striped text-left" cellspacing="0" width="100%">
                            <thead>
                            ...
                            <tbody>
                                ...
                                $stmt = $DBcon->prepare("SELECT activity.*, student.*, department.*,actregister.*  FROM actregister
