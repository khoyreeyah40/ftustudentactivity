...
if (isset($_POST['id'])) {
    $id = $_POST['id'];
    $stmt_view = $DB_con->prepare('SELECT activity.*, mainorg.*, organization.*,acttype.* FROM activity
...
<div class="card-body">
    <div class="row mt-2">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <label>ภาคการเรียน</label>
                <select class="form-control" style="width: 100%;" name="actSem" readonly>
                    <option> <?php echo $actSem; ?></option>
                </select>
            </div>
        </div>
        <div class="col-sm-4">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <select class="form-control" style="width: 100%;" name="actType" readonly>
                    <option> <?php echo $acttypeName; ?></option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-2">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input class="form-control" type="file" name="actFile" src="../file/<?php echo $actFile; ?>" />
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
