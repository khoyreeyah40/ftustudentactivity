...
if (isset($_GET['update_id']) && !empty($_GET['update_id'])) {
    $id = $_GET['update_id'];
    $stmt_update = $DB_con->prepare('SELECT activity.*, mainorg.*, organization.*, acttype.*,actsem.* FROM activity
...
?>
            <script>
                ...
                window.location.href = 'actreq.php';
            </script>
<?php
        } else {
            $errMSG = "พบข้อผิดพลาด";
    ...
    <div class="page-content fade-in-up" style="padding:20px;padding-top:0px">
        <div class="page-heading">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">แก้ไขข้อมูลคำร้องขอกิจกรรม</li>
            </ol>
        </div>
        <br>
        <?php
      ...
      <div class="ibox-head" style="background-color:#d1cbaf;">
        <div class="ibox-title" style="color:#484848;">
                    <h5>แก้ไขข้อมูลคำร้องขอกิจกรรม</h5>
                </div>
            </div>
            <div class="ibox-body">
                <form class="form-horizontal" enctype="multipart/form-data" id="form-sample-1" method="post" novalidate="novalidate">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <?php
                            $sql = "SELECT orgzerSec FROM organizer WHERE orgzerID = '$actby'";
                            ...
                            ?>
                                <option disabled="disabled">--ระดับ--</option>
                        ...
                        <div class="col-sm-5">
                            ...
                            WHERE organizer.orgzerID='$actby' ";
                                    $result = $conn->query($sql);
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <?php
                            $sql = "SELECT orgzerSec,orgzerOrgtion FROM organizer WHERE orgzerID = '$actby'";
                            $result = mysqli_query($conn, $sql);
                            mysqli_num_rows($result);
                            // output data of each row
                            $row = mysqli_fetch_assoc($result);
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <a href="../file/<?php echo $actFile; ?>"><?php echo $actFile; ?></a>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-center">
                            <button class="btn btn-warning" type="submit" name="btupdateactreq">แก้ไข</button>
                            <a href="actreq.php"><button class="btn btn-danger" type="button">ยกเลิก</button></a>
                        </div>
                    </div>
                </form>
            </div>
