...
if (isset($_POST['btaddnews'])) {
  ...
  if (!isset($errMSG)) {
    $stmt = $DBcon->prepare("INSERT INTO news(newsTitle,newsStatus, newsDescribe, newsAddby, newsImage) VALUES
      ...
      <div class="ibox-body">
        <form class="form-horizontal" enctype="multipart/form-data" id="form-sample-1" method="post" novalidate="novalidate">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-5">
              <input class="form-control" type="text" name="newsAddby" value="<?php echo $newsAddby; ?>" readonly />
            </div>
          </div>
          <div class="form-group row">
            <div class="col-sm-12 text-center">
              <button class="btn btn-info" type="submit" name="btaddnews">เพิ่ม</button>
              <a href="news.php"><button class="btn btn-danger" type="button" data-dismiss="ibox">ยกเลิก</button></a>
            </div>
          </div>
        </form>
      </div>
      ...
      <div class="col-12">
        <div class="card"style="border-width:0px;border-bottom-width:4px;border-right-width:4px;">
          ...
          <div class="card-body text-nowrap">
            <table id="tbnews" class="table table-hover-sm table-striped text-center" cellspacing="0" width="100%">
              <thead>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-sm btn-warning" href="updatenews.php?update_id=<?php echo $row['newsNo']; ?>" title="ต้องการแก้ไขข่าว" onclick="return confirm('ต้องการแก้ไขข่าว ?')"><span class="fa fa-edit"></span> แก้ไข</a>
                    </td>
                    <td>
                      <a class="btn btn-sm  btn-danger" href="?delete_id=<?php echo $row['newsNo']; ?>" title="ลบข่าว" onclick="return confirm('ต้องการลบข่าว ?')"> <i class="fa fa-trash"></i> ลบ</a>
                    </td>
                  </tr>
                <?php
                }
