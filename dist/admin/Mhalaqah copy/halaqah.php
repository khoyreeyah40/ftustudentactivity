      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header" style="background-color:#2a9d8f">
            <h5 style="color:white">ตารางกลุ่มศึกษาอัลกุรอ่านของฉัน</h5>
          </div>
          <!-- /.card-header -->
          <div class="card-body text-nowrap">
            <table id="tbhalaqah" class="table table-hover-sm table-striped text-center" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th>ปีการศึกษา</th>
                  <th>รหัสกลุ่ม</th>
              ...
              ?>
                  <tr>
                    ...
                    <td>
                    <a href="halaqahchecklist.php?halaqah_id=<?php echo $row['halaqahtcNo']; ?>"><button class="btn btn-success btn-sm m-r-5" data-toggle="tooltip" ><i class="fa fa-check font-30"></i>เช็คชื่อ</button></a>
                    </td>
