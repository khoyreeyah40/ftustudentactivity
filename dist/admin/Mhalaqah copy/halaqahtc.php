...
<body class="fixed-navbar">
  ...
  <div class="page-content fade-in-up" style="padding:20px;padding-top:0px">
    ...
    <br>
    <a class="btn btn-info" href="../Morganizer/organizer.php" type="button"> <span class="fa fa-pencil"></span> &nbsp; จัดการเจ้าหน้าที่</a>&nbsp;&nbsp;
    <a class="btn btn-info" href="../Morganizer/usertype.php" type="button"> <span class="fa fa-pencil"></span> &nbsp; จัดการประเภทผู้ใช้</a>&nbsp;&nbsp;
    <a class="btn btn-info" href="../Morganizer/organization.php" type="button"> <span class="fa fa-pencil"></span> &nbsp; เพิ่มรายชื่อองค์กร</a>&nbsp;&nbsp;
    <a class="btn btn-info" href="../Morganizer/mainorg.php" type="button"> <span class="fa fa-pencil"></span> &nbsp; เพิ่มรายชื่อสังกัด</a>
    <br>
    <br>
    <?php
    if (isset($errMSG)) {
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header" style="background-color:#2a9d8f">
            <h5 style="color:white">ตารางรายชื่อที่ปรึกษากลุ่มศึกษาอัลกุรอ่าน</h5>
          </div>
          <!-- /.card-header -->
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                      <a href="halaqahstd.php?halaqah_id=<?php echo $row['halaqahtcNo']; ?>"><button class="btn btn-info btn-sm m-r-5" data-toggle="tooltip" ><i class="fa fa-child font-30"></i>รายชื่อนักศึกษา</button></a>
                      </td>
