    ...
    <div class="page-content fade-in-up" style="padding:20px;padding-top:0px">
        <div class="page-heading">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="member.php">จัดการผู้ดูแลระบบ</a></li>
        ...
        <div class="ibox" style="box-shadow: 0 5px 4px rgba(0,0,0,.1);">
            ...
            <div class="ibox-body">
                <form class="form-horizontal" enctype="multipart/form-data" id="form-sample-1" method="post" novalidate="novalidate" style="height:550px; width:100%">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 text-center">
                            ...
                            <a href="member.php"><button class="btn btn-danger" type="button">ยกเลิก</button></a>
                        </div>
                    </div>
                </form>
            </div>
