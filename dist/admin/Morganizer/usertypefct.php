        ...
        while ($roid = mysqli_fetch_assoc($resulda)) {
            ...
            $sqlu = "UPDATE usertype 
                        SET M_1='$trdo1',M_2='$trdo2',,M_3='$trdo3',
                            M_4='$trdo4',M_5='$trdo5',
                            M_6='$trdo6',M_7='$trdo7',M_8='$trdo8',
                            M_9='$trdo9',M_11='$trdo11'
    ...
    if ($eutype && $eutypeMainorg != "") {
        ...
        if ($result->num_rows > 0) {
            ...
            if (!isset($_POST["cb3"])) {
                ...
                $eucheck3 = $_POST["cb2"];
                //echo "cb3 is not blank.".$eucheck2;
            }
            //checkbox 4
            if (!isset($_POST["cb4"])) {
                $eucheck4 = "false";
            ...
            $sql2 = "INSERT INTO usertype (userType, usertypeMainorg,M_1, M_2, M_3,M_4, M_5, M_6, M_7,M_8, M_9, M_11, usertypeAddby) VALUES ('$eutype','$eutypeMainorg','$eucheck1','$eucheck2','$eucheck3','$eucheck4','$eucheck5','$eucheck6','$eucheck7','$eucheck8','$eucheck9','$eucheck11','$usertypeAddby')";
            if (mysqli_query($conn, $sql2)) {
                $successMSG = "ทำการเพิ่มประเภทผู้ใช้สำเร็จ";
                header("refresh:1; usertypefct.php");
            } else {
...
if (isset($_GET['delete_id'])) {
    ...
    header("Location: usertypefct.php");
}
?>
...
<body class="fixed-navbar" style="background-color:#f3e9d2;">
    ...
    <div class="page-content fade-in-up" style="padding:20px;padding-top:0px">
        <div class="page-heading">
            <h1 class="page-title">จัดการประเภทผู้ใช้</h1>
            <ol class="breadcrumb">
                    ...
                    <div class="card-body  text-nowrap">
                        <table id="tbusertype" class="table table-bordered  table-striped table-md text-center">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT orgzerMainorg,orgzerAddby FROM organizer WHERE orgzerID = '$usertypeAddby'";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    require_once '../../db/dbconfig.php';
                                    $stmt = $DBcon->prepare(
                                        "SELECT usertype.*, mainorg.* FROM usertype
                                    JOIN mainorg ON usertype.usertypeMainorg = mainorg.mainorgNo WHERE usertypeMainorg='$main' && usertypeAddby!='$orgzerAddby' ORDER BY usertypeID DESC"
                                    );
                                    $stmt->execute();
