...
if (isset($_POST['btaddusertype'])) {
    ...
    if ($eutype && $eutypeMainorg != "") {
        ...
        if ($result->num_rows > 0) {
            ...
            $sql2 = "INSERT INTO usertype (userType,usertypeMainorg,M_1, M_2, M_3, M_4, M_5, M_6, M_7, M_8, M_9, M_10, M_11, M_12, M_13, usertypeAddby) VALUES ('$eutype','$eutypeMainorg','$eucheck1','$eucheck2','$eucheck3','$eucheck4','$eucheck5','$eucheck6','$eucheck7','$eucheck8','$eucheck9','$eucheck10','$eucheck11','$eucheck12','$eucheck13','$usertypeAddby')";
...
<body class="fixed-navbar" style="background-color:#f3e9d2;">
    ...
    <div class="page-content fade-in-up" style="padding:20px;padding-top:0px">
        ...
        <a class="btn btn-info" href="organization.php" type="button"> <span class="fa fa-pencil"></span> &nbsp; จัดการรายชื่อองค์กร</a>&nbsp;&nbsp;
        <a class="btn btn-info" href="mainorg.php" type="button"> <span class="fa fa-pencil"></span> &nbsp; จัดการรายชื่อสังกัด</a>
        <br>
        <br>
        <?php
        if (isset($errMSG)) {
            ...
            <div class="ibox-body">
                <form class="form-horizontal" id="form-sample-1" method="post" novalidate="novalidate">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <select class="form-control select2_demo_1" style="width: 100%;" name="usertypeMainorg" required>
                                <option selected="selected" disabled="disabled">--สังกัด--</option>
                                <?php
                                $sql = "SELECT mainorg FROM mainorg ";
                                ...
                                ?>
                                        <option value="<?php echo $mainorglist ?>"> <?php echo $mainorglist ?></option>
                                <?php
                                    }
                                } else {
                                    echo "something";
                    ...
                    <div class="card-body  text-nowrap">
                        <table id="tbusertype" class="table table-bordered  table-striped table-md text-center">
                            ...
                            <tbody>
                                <?php
                                include '../../db/dbcon.php';
                                $sqld = "SELECT * FROM usertype WHERE usertypeAddby = '$usertypeAddby'";
                                ...
                                ?>
                                        <form method="POST">
                                            <tr>
                                                ...
                                                <td><?php echo $row['usertypeMainorg']; ?>
                                                </td>
                                            </tr>
                                    <?php }
                                } else {
