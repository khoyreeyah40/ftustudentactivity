                ...
                <div class="language">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown"style="color:#528124;">
                            ...
                            <span></span><?php echo $_SESSION['orgzerName']; ?><i class="fa fa-angle-down m-l-5"></i></a>
            ...
            <div id="sidebar-collapse" >
                <div class="admin-block d-flex">
                    ...
                    <div class="admin-info"style="color:#528124;">
                        <div class="font-strong"><?php echo $orgzerRow['orgzerName']; ?></b></a></div><small style="color:#528124;"><?php echo $orgzerRow['userType']; ?></small>
                    </div>
                </div>