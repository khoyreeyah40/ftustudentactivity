...
if (isset($_GET['delete_id'])) {
  $stmt_select = $DBcon->prepare('SELECT * FROM eiatiqaf WHERE eiatiqafNo =:eiatiqafNo');
  ...
  $stmt_delete = $DBcon->prepare('DELETE FROM eiatiqaf WHERE eiatiqafNo =:eiatiqafNo');
                                                            ...
                                                            <table id="tbact1" class="table table-condensed ">
                                                                ...
                                                                <!--act1กลุ่มศึกษาอัลกุรอ่าน-->
                                                                    ...
                                                                    <tr><?php
                                                                        ...
                                                                        $stmt->execute();
                                                                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {?>
                                                                        <td style="font-size:16px;width: 30%;border-top: 0px;"><h6>ที่ปรึกษา: <a href="javascript:;"><?php echo $row['orgzerName'];?></a></h6></td>
                                                                        <td>ภาคเรียนที่ 2</td>
                                                                        <td></td>
                                                                        <td></td>
                                                                        <?php
