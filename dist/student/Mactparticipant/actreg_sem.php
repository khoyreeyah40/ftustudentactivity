    ...
    <div class="page-content fade-in-up" style="padding:20px;padding-top:0px">
        <div class="page-heading">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="actparticipant.php">การเข้าร่วมกิจกรรม</a></li>
                                    ...
                                    <table id="tbact1" class="table table-striped table-hover" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <?php
                                                require_once '../../db/dbconfig.php';
                                                $stmt = $DBcon->prepare("SELECT activity.*, actsem.*,acttype.*,actregister.*,mainorg.*,organization.*
                                                FROM actregister 
                                                ...
                                                && (activity.actYear = '$actyear' && actsem.actsem = '$actsem') 
