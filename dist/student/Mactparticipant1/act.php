                            ...
                            <div class="tab-pane fade show active" id="tab-1">
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-nowrap">
                                                <table id="tbhal" class="table table-condensed  text-center">
                                                    <thead>
                                                        <tr>
                                                            <th>ที่ปรึกษาฮาลาเกาะห์</th>
                                                            <th>ภาคเรียน</th>
                                                            <th>ผลการประเมิน</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php
                                                        require_once '../../db/dbconfig.php';
                                                        $stmt = $DBcon->prepare("SELECT * FROM halaqah WHERE stdID='$stdID'");
                                                        $stmt->execute();
                                                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                                        ?>
                                                            <tr>
                                                                <td><?php echo $row['halaqahTc']; ?></td>
                                                                <td>ภาคเรียนที่1</td>
                                                                <td><?php echo $row['halaqahResult']; ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td><?php echo $row['halaqahTc']; ?></td>
                                                                <td>ภาคเรียนที่2</td>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-nowrap">
                                                <table id="tbeitiqaf" class="table table-bordered table-striped text-center">
                                                    <thead>
                                                        <tr>
                                                            <th>ชื่อสถานที่</th>
                                                            <th>ผลการประเมิน</th>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header" style="background-color:#2a9d8f">
                                                <h5 style="color:white">ค่ายพัฒนาศักยภาพนักศึกษา</h5>
                                            </div>
                                            <!-- /.card-header -->
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-nowrap">
                                                <table id="tbpajchim" class="table table-bordered table-striped text-center">
                                                    <thead>
                                                        <tr>
                                                            <th>วันที่</th>
                                                            <th>สถานที่</th>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header" style="background-color:#2a9d8f">
                                                <h5 style="color:white">ชุมนุม</h5> &nbsp;&nbsp;<button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modalmoreinfo" data-id="<?php echo $row['actNo']; ?>" id="moreinfo"><i class="fa fa-eye-open"></i> เพิ่มเติม</button>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-nowrap">
                                                <table id="tbeitiqaf2" class="table table-bordered table-striped text-center">
                                                    <thead>
                                                        <tr>
                                                            <th>ชื่อสถานที่</th>
                                                            <th>ผลการประเมิน</th>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-nowrap">
                                                <table id="tbeitiqaf3" class="table table-bordered table-striped text-center">
                                                    <thead>
                                                        <tr>
                                                            <th>ชื่อสถานที่</th>
                                                            <th>ผลการประเมิน</th>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-nowrap">
                                                <table id="tbeitiqaf4" class="table table-bordered table-striped text-center">
                                                    <thead>
                                                        <tr>
                                                            <th>ชื่อสถานที่</th>
                                                            <th>ผลการประเมิน</th>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body text-nowrap">
                                                <table id="tbpajchim4" class="table table-bordered table-striped text-center">
                                                    <thead>
                                                        <tr>
                                                            <th>วันที่</th>
                                                            <th>สถานที่</th>
