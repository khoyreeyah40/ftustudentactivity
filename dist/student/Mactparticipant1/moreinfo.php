...
if (isset($_POST['id'])) {
    $id = $_POST['id'];
    $stmt_view = $DB_con->prepare('SELECT actYear,actStatus,actName,actSec,actMainorg,actOrgtion,actType,actGroup,actReason,actPurpose,actStyle,actTimeb,actTimee,actDateb,actDatee,actLocate,actPay,actNote FROM activity WHERE actNo=:id');
    ...
    <div class="row mt-2">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="actNote" value="<?php echo $actNote; ?>" readonly />
            </div>
        </div>
    </div>
</div>