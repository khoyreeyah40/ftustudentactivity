...
<body class="fixed-navbar">
    <div class="page-wrapper">
        ...
        <ul class="side-menu metismenu">
            <li class="active">
                <a href="actregisterpage.php" aria-hidden="true"><i class="sidebar-item-icon fa fa-list-alt"></i>
    ...
    <div class="content-wrapper">
        ...
        <div class="page-content fade-in-up">
            <div class="row">
                <div class="col-12">
                    <iframe height="1084px" width="100%" name="iii" src="actregister.php" style="border:none"> </iframe>
