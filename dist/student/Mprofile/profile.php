            ...
            <div class="col-lg-3 col-md-4">
                <div class="ibox">
                    <div class="ibox-body text-center">
                        ...
                        <a href="updateprofile.php?update_id=<?php echo $stdRow['stdID']; ?>" title="แก้ไขข้อมูลส่วนตัว" onclick="return confirm('ต้องการแก้ไขข้อมูลส่วนตัว ?')"><button class="btn btn-warning btn-sm m-r-5 btn-fix" data-toggle="tooltip" ><i class="fa fa-pencil font-30"></i> แก้ไขข้อมูลส่วนตัว</button></a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-10">
                                <ul class="list-group list-group-full list-group-divider">
                                    ...
                                    <li class="list-group-item">สาขา
                                        <a href="javascript:;"><span class="pull-right "><?php echo $stdRow['department']; ?></span></a>
                                    </li>
